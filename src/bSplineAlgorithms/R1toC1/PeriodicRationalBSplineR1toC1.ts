...
export class PeriodicRationalBSplineR1toC1 {
    ...
    private readonly spline: PeriodicBSplineR1toC2
    ...
    constructor(controlPoints: Complex2d[] = [new Complex2d({x: 0, y: 0}, {x: 1, y: 0})], knots: number[] = [0, 1]) {
        this.spline = new PeriodicBSplineR1toC2(controlPoints, knots)
    }
    ...
    clone(): PeriodicRationalBSplineR1toC1 {
        return new PeriodicRationalBSplineR1toC1(this.spline.controlPoints, this.spline.knots)
    }
