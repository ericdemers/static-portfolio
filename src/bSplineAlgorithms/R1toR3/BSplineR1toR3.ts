...
export class BSplineR1toR3 extends BaseBSplineR1toR3 {
    ...
    */
    ...
    elevateDegree() {
        ...
        let splineHigherDegree = new BSplineR1toR3(s.controlPolygons[0], s.knotVectors[0]) as BaseBSplineR1toR3
        if(this.knotMultiplicity(this._knots[0]) !== this._degree + 1 || this.knotMultiplicity(this.knots[this._knots.length - 1]) !== this._degree + 1) {
            for( let i = 1; i <= this._degree; i += 1) {
                let splineTemp = new BSplineR1toR3(s.controlPolygons[i], s.knotVectors[i]) as BaseBSplineR1toR3
                let j = 0
                ...
                for( let ind = 0; ind < splineHigherDegree.controlPoints.length; ind += 1) {
                    ...
                    cps[ind] = cp
                    splineHigherDegree = new BSplineR1toR3(cps, splineHigherDegree.knots)
                }
            }
        ...
        return new BSplineR1toR3(splineHigherDegree.controlPoints, splineHigherDegree.knots)
